...
if is_available "toggleterm.nvim" then
  ...
  maps.n["<leader>1"] = { function() utils.toggle_term_key "t1" end, desc = "ToggleTerm 1" }
  maps.n["<leader>2"] = { function() utils.toggle_term_key "t2" end, desc = "ToggleTerm 2" }
  maps.n["<leader>3"] = { function() utils.toggle_term_key "t3" end, desc = "ToggleTerm 3" }
  maps.n["<leader>4"] = { function() utils.toggle_term_key "t4" end, desc = "ToggleTerm 4" }
  maps.n["<leader>5"] = { function() utils.toggle_term_key "t5" end, desc = "ToggleTerm 5" }
